...
### 📌 Описание кейса
Реальная задача по поиску причины критического зависания ноутбука с ОС Linux Mint 22.2 x86_64 (Hard Freeze) при воспроизведении видео. Система намертво зависала, не оставляя логов после перезагрузки.
