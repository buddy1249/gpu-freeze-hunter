...
## 📝 Deep Dive: Why it worked? 
    ...
    • Описание: Сетевой адаптер буферизирует пакеты и инициирует прерывания, которые имеют более высокий приоритет, чем зациклившийся код драйвера в пространстве пользователя или потоки ядра с обычным приоритетом.
