...
### 📌 Описание кейса
Реальная задача по поиску причины критического зависания ноутбука (Hard Freeze) при воспроизведении видео. Система намертво зависала, не оставляя логов после перезагрузки.
